...
public class DatabaseUserRepository implements UserRepository {
        ...
        return executeQuery("SELECT id,name,password,email,phoneNumber FROM users WHERE name=? and password=?",
                resultSet -> {
                    ...
                    while (resultSet.next()) { // 如果存在并且游标滚动 // SQLException
                        setUserInfo(resultSet, userBeanInfo, user);
                    }
                    return user;
    ...
    private void setUserInfo(ResultSet resultSet, BeanInfo userBeanInfo, User user) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException {
